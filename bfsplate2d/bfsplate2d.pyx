...
cdef class BFSPlate2D(object):
    ...
    cdef public cINT init_k_KC0, init_k_KG, init_k_M, init_k_KA
...
cpdef void update_KA(BFSPlate2D plate,
        np.ndarray[cINT, ndim=1] KAr,
        np.ndarray[cINT, ndim=1] KAc,
        np.ndarray[cDOUBLE, ndim=1] KAv,
        ):
    """Update sparse vectors for mass matrix KA

    Properties
    ----------
    plate : `.BFSPlate2D` object
        The plate element being added to KA
    KAr : np.array
        Array to store row positions of sparse values
    KAc : np.array
        Array to store column positions of sparse values
    ...
    with nogil:
        ...
        k = plate.init_k_KA
        KAv[k] += -0.185714285714286*ley
        k += 1
        KAv[k] += 0.0371428571428571*lex*ley
        k += 1
        KAv[k] += -0.0261904761904762*ley**2
        k += 1
        KAv[k] += 0.00523809523809524*lex*ley**2
        k += 1
        KAv[k] += 0.185714285714286*ley
        k += 1
        KAv[k] += -0.0371428571428571*lex*ley
        ...
        KAv[k] += -0.00523809523809524*lex*ley**2
        k += 1
        KAv[k] += 0.0642857142857143*ley
        k += 1
        KAv[k] += -0.0128571428571429*lex*ley
        k += 1
        KAv[k] += -0.0154761904761905*ley**2
        k += 1
        KAv[k] += 0.0030952380952381*lex*ley**2
        k += 1
        KAv[k] += -0.0642857142857143*ley
        k += 1
        KAv[k] += 0.0128571428571429*lex*ley
        ...
        KAv[k] += 0.0154761904761905*ley**2
        k += 1
        KAv[k] += -0.00309523809523809*lex*ley**2
        k += 1
        KAv[k] += -0.0371428571428571*lex*ley
        k += 1
        KAv[k] += -0.00523809523809524*lex*ley**2
        ...
        KAv[k] += 0.0371428571428571*lex*ley
        k += 1
        KAv[k] += -0.00619047619047619*lex**2*ley
        k += 1
        KAv[k] += 0.00523809523809524*lex*ley**2
        k += 1
        KAv[k] += -0.000873015873015873*lex**2*ley**2
        k += 1
        KAv[k] += 0.0128571428571429*lex*ley
        k += 1
        KAv[k] += -0.00214285714285714*lex**2*ley
        k += 1
        KAv[k] += -0.0030952380952381*lex*ley**2
        k += 1
        KAv[k] += 0.000515873015873016*lex**2*ley**2
        k += 1
        KAv[k] += -0.0128571428571429*lex*ley
        k += 1
        KAv[k] += 0.0030952380952381*lex*ley**2
        ...
        KAv[k] += 0.00523809523809524*lex*ley**2
        k += 1
        KAv[k] += -0.00476190476190476*ley**3
        k += 1
        KAv[k] += 0.000952380952380952*lex*ley**3
        k += 1
        KAv[k] += 0.0261904761904762*ley**2
        k += 1
        KAv[k] += -0.00523809523809524*lex*ley**2
        ...
        KAv[k] += -0.0030952380952381*lex*ley**2
        k += 1
        KAv[k] += -0.00357142857142857*ley**3
        k += 1
        KAv[k] += 0.000714285714285715*lex*ley**3
        k += 1
        KAv[k] += -0.0154761904761905*ley**2
        k += 1
        KAv[k] += 0.0030952380952381*lex*ley**2
        ...
        KAv[k] += 0.00357142857142857*ley**3
        k += 1
        KAv[k] += -0.000714285714285714*lex*ley**3
        k += 1
        KAv[k] += -0.00523809523809524*lex*ley**2
        k += 1
        KAv[k] += -0.000952380952380952*lex*ley**3
        ...
        KAv[k] += 0.000952380952380952*lex*ley**3
        k += 1
        KAv[k] += -0.000158730158730159*lex**2*ley**3
        k += 1
        KAv[k] += 0.0030952380952381*lex*ley**2
        k += 1
        KAv[k] += -0.000515873015873016*lex**2*ley**2
        ...
        KAv[k] += -0.000714285714285714*lex*ley**3
        k += 1
        KAv[k] += 0.000119047619047619*lex**2*ley**3
        k += 1
        KAv[k] += -0.0030952380952381*lex*ley**2
        k += 1
        KAv[k] += 0.000714285714285715*lex*ley**3
